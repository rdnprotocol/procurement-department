...
export const metadata = {
  title: "Төлөвлөгөө, тайлан | Тендер",
  description: "Тендертэй холбоотой төлөвлөгөө, тайлангийн мэдээлэл",
};

export const revalidate = 60;

export default async function TenderPlanPage() {
    ...
    <Container>
      <div className="max-w-7xl mx-auto py-12 px-4">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-600 mb-8">
          ...
          <span>/</span>
          <Link href="/activities/tender" className="hover:text-emerald-600 transition-colors">
            Тендер
          </Link>
          <span>/</span>
