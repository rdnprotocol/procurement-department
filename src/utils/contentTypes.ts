...
export const STATIC_CONTENT_TYPES: ContentType[] = [
  ...
  // Ил тод байдал - Бодлогын баримт бичиг
  { value: 'policy-intro', label: 'Бодлогын баримт бичиг танилцуулга', group: 'Бодлогын баримт бичиг', description: 'Бодлогын баримт бичгийн танилцуулга' },
  { value: 'policy-documents', label: 'Бодлогын баримт бичгүүд', group: 'Бодлогын баримт бичиг', description: 'Хууль тогтоомж, дүрэм журам' },
  { value: 'policy-rules', label: 'Дотоод журам', group: 'Бодлогын баримт бичиг', description: 'Байгууллагын дотоод журам' },
  
  // Ил тод байдал - Стратеги төлөвлөгөө
  { value: 'strategy-intro', label: 'Стратеги танилцуулга', group: 'Стратеги төлөвлөгөө', description: 'Стратеги төлөвлөгөөний танилцуулга' },
  { value: 'strategy-goals', label: 'Стратегийн зорилтууд', group: 'Стратеги төлөвлөгөө', description: 'Байгууллагын стратегийн зорилтууд' },
  { value: 'strategy-plan', label: 'Стратеги төлөвлөгөө', group: 'Стратеги төлөвлөгөө', description: 'Урт хугацааны төлөвлөгөө' },
  
  // Ил тод байдал - Төлөвлөгөө тайлан
  { value: 'plan-intro', label: 'Төлөвлөгөө тайлан танилцуулга', group: 'Төлөвлөгөө тайлан', description: 'Төлөвлөгөө тайлангийн танилцуулга' },
  { value: 'plan-annual', label: 'Жилийн төлөвлөгөө', group: 'Төлөвлөгөө тайлан', description: 'Жилийн ажлын төлөвлөгөө' },
  { value: 'plan-report', label: 'Гүйцэтгэлийн тайлан', group: 'Төлөвлөгөө тайлан', description: 'Гүйцэтгэлийн тайлан' },
  
  // Ил тод байдал - Статистик мэдээ
